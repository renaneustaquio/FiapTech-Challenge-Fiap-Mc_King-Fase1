...
namespace Domain.Tests.Produtos
{
    public class ProdutoTestes
    {
        ...
        [Fact]
        public void SetCodigo_AlterarCodigo_DeveAtualizarCodigo()
        {
            var sut = Builder<Produto>.CreateNew().Build();
            sut.SetCodigo(12345);
            sut.Codigo.Should().Be(12345);
        }
